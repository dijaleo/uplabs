 ...
 * @author moulo
 */
public class transactionsClient extends javax.swing.JFrame {

    /**
     * Creates new form transactionsClient
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Transactions client");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transactionsClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new transactionsClient().setVisible(true);
            }
        });
    }
